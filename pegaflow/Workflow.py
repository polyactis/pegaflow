...
class Workflow(PegaWorkflow):
    ...
    def __init__(self,
        ...
        self.add_site_catalog(self.create_site_catalog(exec_site_name=self.site_handler))
    ...
    def create_pegasus_properties(self):
        ...
        self.pegasus_props["pegasus.file.cleanup.clusters.size"] = "15"

        return self.pegasus_props


    # --- Site Catalog -------------------------------------------------------------
    def create_site_catalog(self, exec_site_name="condor", local_storage_folder_name="output",
